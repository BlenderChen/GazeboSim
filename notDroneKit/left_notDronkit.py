...
def move_left_from_initial(vehicle, distance):
    ...
    # Calculate the new target location left from the initial location
...
if __name__ == "__main__":
    ...
    # Move the drone 5 meters left from its initial location
    move_left_from_initial(vehicle, 5)
