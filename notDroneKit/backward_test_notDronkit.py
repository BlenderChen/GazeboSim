...
def move_backward_from_initial(vehicle, distance):
    ...
    # Calculate the new target location backward from the initial location
...
# Example usage: Move the drone 5 meters backward from its initial location
move_backward_from_initial(vehicle, 5)
